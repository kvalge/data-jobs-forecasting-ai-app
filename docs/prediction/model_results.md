...
- **Generated at:** 2026-07-30T05:49:20
- **Run id:** 5
- **Status:** completed
...
- **Elapsed (seconds):** 945.31

## Training data

Models were trained on generated job-market aggregates (not live PostgreSQL postings). Regenerate with `python scripts/generate_fake_job_market.py`. Use the **Prediction (database)** UI tab or `PREDICTION_DATA_SOURCE=database` for live posting aggregates.
